        ...
        <div className="footer__table">
          <div className="footer__table-col">
            ...
            <nav className="footer__links nav-quick-links">
              <NavLink to={routeNames.homepage} cls={navQuickLinkCls}>
                Home
              </NavLink>
              <NavLink to={routeNames.about} cls={navQuickLinkCls}>
                About
              </NavLink>
              <NavLink to={"/#projects"} cls={navQuickLinkCls}>
                Projects
              </NavLink>
              <NavLink to={routeNames.contact} cls={navQuickLinkCls}>
                Contact
              </NavLink>
              <NavLink to={routeNames.blog} cls={navQuickLinkCls}>
                Blog
              </NavLink>
              <NavLink to={"/#our-policy"} cls={navQuickLinkCls}>
                Our Policy
              </NavLink>
              <NavLink to={"/#career"} cls={navQuickLinkCls}>
                Career
              </NavLink>
            </nav>
          </div>
          <div className="footer__table-col">
            ...
            <nav className="footer__links">
              <NavLink to={"/#web-development"} cls={navLinkCls}>
                Web Development
              </NavLink>
              <NavLink to={"/#digital-product-design"} cls={navLinkCls}>
                Digital Product Design
              </NavLink>
              <NavLink to={"/#cloud-devops"} cls={navLinkCls}>
                Cloud/DevOps
              </NavLink>
              <NavLink to={"/#mobile-applications"} cls={navLinkCls}>
                Mobile Applications
              </NavLink>
              <NavLink to={"/dedicated-development"} cls={navLinkCls}>
                Dedicated Development
              </NavLink>
              <NavLink to={"/#team"} cls={navLinkCls}>
                Team
              </NavLink>
            </nav>
          </div>
          <div className="footer__table-col">
            ...
            <nav className="footer__links">
              <NavLink to={"/#laravel-development"} cls={navLinkCls}>
                Laravel Development
              </NavLink>
              <NavLink to={"/#react-js-app-development"} cls={navLinkCls}>
                React JS App Development
              </NavLink>
              <NavLink to={"/#vue-js-app-development"} cls={navLinkCls}>
                Vue JS App Development
              </NavLink>
            </nav>
          </div>
          <div className="footer__table-col footer__table-col_social">
